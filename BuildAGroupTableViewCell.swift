...
//  GroupVault
//
//  Created by Jonathan Rogers on 7/19/16.
...
class BuildAGroupTableViewCell: UITableViewCell {
    ...
    weak var delegate: BuildAGroupTableViewCellDelegate?
    ...
    @IBAction func addUserButtonTapped(sender: AnyObject) {
        ...
        if let delegate = delegate {
            delegate.addUserButtonTapped(self)
        }
...
protocol BuildAGroupTableViewCellDelegate: class {

...
class MessageController {
    ...
    static func newDeleteGroupMessagesBasedOnDate(message: Message) {
        
    }
    
    //    static func changeMessageDateString(messages: [Message]) {
    //
    //        for message in messages {
    //
    //            var messageDateString = message.dateString
    //            print(messageDateString)
    //            let formatter = NSDateFormatter()
    //            var newFormat = formatter.dateFormat
    //            newFormat = "HH"
    //            print(newFormat)
    //
    //            messageDateString = newFormat
    //            print(messageDateString)
    //
    //
    //        }
    ...
    func deleteGroupMessagesBasedOnViews(message: Message) {
